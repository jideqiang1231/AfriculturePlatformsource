 ...
 * @description：$des$
 **/
public class SpecialistagritechlistBean {
////////////////////////////////////////////////////////////////////////////
    //这段bean可以复用，但是还是重新创建了个bean接收
/////////////////////////////////////////////////////////////////
    /**
     * msg : 农技信息数据请求成功
     * specialistnongjiresult : [{"recommendId":1,"specialistId":1,"seedName":"宁粳43","recommendTime":"2019-11-16","recommendContent":"3月上旬春天地未化通时，进行两遍耙耱保墒整地，用对角耙轻耥，达到地平土碎，以利蓄墒保墒要求；4月初田间潮水落下后，施基肥后及时耙地耥地，镇压后待播。也可采用秋施肥、春免耕的办法保墒播种。播种前对土壤进行普遍镇压，达到提墒和控制播深的目的。","recommendArea":"永宁,灵武,吴忠,青铜峡,中宁,中卫"},{"recommendId":2,"specialistId":1,"seedName":"水稻2号","recommendTime":"2020-04-22","recommendContent":"激发了卡拉就是打开六十六公斤阿拉斯加的；爱丽丝大家噶可是大家gals大驾光临啊拉卡拉少见多怪啊","recommendArea":"永宁,市中心,石嘴山"}]
     */

    private String msg;
    private List<SpecialistnongjiresultBean> specialistnongjiresult;
    ...
    public List<SpecialistnongjiresultBean> getSpecialistnongjiresult() {
        return specialistnongjiresult;
    }

    public void setSpecialistnongjiresult(List<SpecialistnongjiresultBean> specialistnongjiresult) {
        this.specialistnongjiresult = specialistnongjiresult;
    }

    public static class SpecialistnongjiresultBean {
        /**
         * recommendId : 1
         * specialistId : 1
         * seedName : 宁粳43
